  ...
  $(".parallax").ripples({
    ...
    //   On Curriculum Section
        if (scroll > $(window).innerHeight() * 2 && scroll < $(window).innerHeight() * 5){
          $("#navbar").css({"display":"block","background":"rgba(0, 0, 0, 0.6)", "transition":"0.3s ease-in-out"});
        ...
        // First on About section and second on Portfolio Section
            ...
            $("#navbar").css({"display":"block","background":"rgba(255, 255, 255, 0.6)","transition":"0.3s ease-in-out","box-shadow":"0 2px 2px -2px rgba(0,0,0,.2)"}); 
        ...
        else if((scroll >= $(window).innerHeight() * 6 && scroll < $(window).innerHeight() * 8)){
          $("#navbar").css({"display":"none"});
      }
        else{
            $("#navbar").css({"display":"block","background":"transparent","transition":"0.3s ease-in-out", "box-shadow":"none"});   
